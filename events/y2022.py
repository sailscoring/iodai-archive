...
SERIES = [
    ...
    main_fleet('iodai-leinsters-2022-main-fleet', 'IODAI Leinsters 2022 — Main Fleet',
               ...
               suspect=['1639', '1467'], **SSC, event_url='https://iodai.com/skerries-leinsters-results/'),
    solo('iodai-leinsters-2022-regatta', 'IODAI Leinsters 2022 — Regatta',
         'Skerries Sailing Club', ['2022-06-18', '2022-06-19'], nslots=7,
         file=L + 'SSC2022R.html', fleet='Regatta', discards=[(4, 1), (7, 2)], **SSC, event_url='https://iodai.com/skerries-leinsters-results/'),
    ...
    main_fleet('iodai-ulsters-2022-main-fleet', 'IODAI Ulsters 2022 — Main Fleet',
               ...
               senior=U + 'OHYC2022S.html', junior=U + 'OHYC2022J.html', **HYC, event_url='https://iodai.com/optimist-ulsters-hyc-results/'),
    solo('iodai-ulsters-2022-regatta-racing', 'IODAI Ulsters 2022 — Regatta Racing',
         ...
         discards=[(4, 1), (8, 2)], **HYC, event_url='https://iodai.com/optimist-ulsters-hyc-results/'),
    ...
    solo('iodai-ulsters-2022-regatta-coached', 'IODAI Ulsters 2022 — Regatta Coached',
         ...
         file=U + 'OHYC2022RC.html', fleet='Regatta Coached', **HYC, event_url='https://iodai.com/optimist-ulsters-hyc-results/'),
    ...
    main_fleet('iodai-connachts-2022-main-fleet', 'IODAI Connachts 2022 — Main Fleet',
               ...
               senior=C + 'G2022S.html', junior=C + 'G2022J.html', **GBSC, event_url='https://iodai.com/galway-bay-connaughts-results/'),
    solo('iodai-connachts-2022-regatta', 'IODAI Connachts 2022 — Regatta',
         'Galway Bay Sailing Club', ['2022-07-09', '2022-07-10'], nslots=4,
         file=C + 'G2022R.html', fleet='Regatta', **GBSC, event_url='https://iodai.com/galway-bay-connaughts-results/'),
    ...
    main_fleet('iodai-munsters-2022-main-fleet', 'IODAI Munsters 2022 — Main Fleet',
               ...
               senior=M + 'RCYC2022M.html', junior=M + 'RCYC2022J.html', **RCYC, event_url='https://iodai.com/rcyc-munsters-results/'),
    solo('iodai-munsters-2022-regatta', 'IODAI Munsters 2022 — Regatta',
         'Royal Cork Yacht Club', ['2022-05-21'], nslots=5,
         file=M + 'RCYC2022R.html', fleet='Regatta', **RCYC, event_url='https://iodai.com/rcyc-munsters-results/'),
    ...
    main_fleet('iodai-nationals-2022-main-fleet', 'IODAI Nationals 2022 — Main Fleet',
               ...
               suspect=['1651', '1493'], **RSGYC, event_url='https://iodai.com/optimist-nationals-results/'),
    solo('iodai-nationals-2022-regatta-racing', 'IODAI Nationals 2022 — Regatta Racing',
         ...
         discards=[(4, 1), (10, 2)], **RSGYC, event_url='https://iodai.com/optimist-nationals-results/'),
