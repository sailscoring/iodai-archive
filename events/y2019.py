...
SERIES = [
    ...
    main_fleet('iodai-leinsters-2019-main-fleet', 'IODAI Leinsters 2019 — Main Fleet',
               ...
               senior=L + 'lese19os.html', junior=L + 'leju19os.html', **MYC, event_url='https://iodai.com/results-leinsters-2019-malahide-yacht-club/'),
    ...
    solo('iodai-leinsters-2019-regatta', 'IODAI Leinsters 2019 — Regatta',
         ...
         file=L + 'lere19os.html', fleet='Regatta', suspect=['1587'], **MYC, event_url='https://iodai.com/results-leinsters-2019-malahide-yacht-club/'),
    ...
    main_fleet('iodai-ulsters-2019-main-fleet', 'IODAI Ulsters 2019 — Main Fleet',
               ...
               senior=U + 'ulse19os.html', junior=U + 'ulju19os.html', **SSC, event_url='https://iodai.com/results-ulsters-2019-skerries-sailing-club/'),
    solo('iodai-ulsters-2019-regatta', 'IODAI Ulsters 2019 — Regatta',
         'Skerries Sailing Club', ['2019-05-25', '2019-05-26'], nslots=4,
         file=U + 'ulre19os.html', fleet='Regatta', **SSC, event_url='https://iodai.com/results-ulsters-2019-skerries-sailing-club/'),
    ...
    main_fleet('iodai-connachts-2019-main-fleet', 'IODAI Connachts 2019 — Main Fleet',
               ...
               senior=C + 'cose19os.html', junior=C + 'coju19os.html', **LRYC, event_url='https://iodai.com/results-connaughts-2019-lough-ree-yacht-club/'),
    solo('iodai-connachts-2019-regatta', 'IODAI Connachts 2019 — Regatta',
         'Lough Ree Yacht Club', ['2019-09-07', '2019-09-08'], nslots=3,
         file=C + 'core19os.html', fleet='Regatta', **LRYC, event_url='https://iodai.com/results-connaughts-2019-lough-ree-yacht-club/'),
    ...
    main_fleet('iodai-munsters-2019-main-fleet', 'IODAI Munsters 2019 — Main Fleet',
               ...
               senior=M + 'muse19os.html', junior=M + 'muju19os.html', event_url='https://iodai.com/results-munsters-2019-wexford-harbour-sailing-club/'),
    ...
    main_fleet('iodai-nationals-2019-main-fleet', 'IODAI Nationals 2019 — Main Fleet',
               ...
               discards=[(4, 1), (9, 2)], **HYC, event_url='https://iodai.com/results-nationals-2019-howth-yacht-club/'),
